...
class VagasAdmin(admin.ModelAdmin):
    ...
    list_filter = ('empresa', 'status', 'tipo_vaga', 'area', 'sigiloso', 'consultoria', 'aproveitamento')
    ...
    fieldsets = (
        ...
        ('Fechamento / Candidato', {
            'fields': ('motivo', 'aproveitamento', 'justificativa', 'nome_candidato', 'previsao_admissao', 'observacoes'),
        }),
    )
